package com.example.pufferfish.worldgen.structures;
...
public class Structures {
    ...
    public static void registerConfiguredStructures() {
        Registry.register(BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE, new ResourceLocation(PufferFish.MODID, "thiefden"), CONFIGURED_THIEFDEN);
        Registry.register(BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE, new ResourceLocation(PufferFish.MODID, "portal_overworld"), CONFIGURED_PORTAL_OVERWORLD);
        Registry.register(BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE, new ResourceLocation(PufferFish.MODID, "portal_mysterious"), CONFIGURED_PORTAL_MYSTERIOUS);
    }
